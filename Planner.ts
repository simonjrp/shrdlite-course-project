                    ...
                    switch (relation) {
                        ...
                        case Interpreter.Rel.inside:
                            if (destination === "floor") {
                                ...
                                for (var k: number = 0; k <n.state.stacks.length; k++) {
                                    destIndex = n.state.stacks[k].indexOf(destination);
                                    if (destIndex != -1) {
                                        if (destIndex <n.state.stacks[k].length - 1 && n.state.stacks[k][destIndex + 1] === objToMove) {
                                            isGoal = true
                                        }
                                        break;
                                    }
                        ...
                        case Interpreter.Rel.beside:
                            for (var k: number = 0; k <n.state.stacks.length; k++) {
                                destIndex = n.state.stacks[k].indexOf(destination);
                                if (destIndex != -1) {
                                    if ((k> 0 && n.state.stacks[k - 1].indexOf(objToMove) != -1) || (k <n.state.stacks.length - 1 && n.state.stacks[k + 1].indexOf(objToMove) != -1)) {
                                        isGoal = true;
                                    }
                                    break;
                                }
